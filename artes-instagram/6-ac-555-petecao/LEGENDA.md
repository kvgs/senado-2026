...
Gerado por `python gerar_artes_candidatura.py --uf AC --numero 555`.

---

## Legenda

**O que já foi levantado sobre Petecão (PSD), tema a tema.**
...
#eleições2026 #senado #acre #petecao #psd #dadosabertos #votoconsciente #transparência
