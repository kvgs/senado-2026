...
Gerado por `python gerar_artes_candidatura.py --uf AP --numero 277`.

---

## Legenda

**O que já foi levantado sobre Juíza Jô (DC), tema a tema.**
...
#eleições2026 #senado #amapa #juizajo #dc #dadosabertos #votoconsciente #transparência
...
- 0 temas com proposta própria, 9 com proposta do partido, 1 sem conteúdo (os dez temas somados)
