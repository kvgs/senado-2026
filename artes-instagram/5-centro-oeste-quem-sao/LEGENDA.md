# Conheça as candidaturas do Centro-Oeste

6 slides: capa clara, 4 estados em ordem alfabética, e o convite.
...
**Você conhece as 44 pessoas que disputam o Senado pelo Centro-Oeste?**

São 4 estados, 44 candidaturas — e este ano você vota em duas.
...
#eleições2026 #senado #centrooeste #distritofederal #goiás #matogrosso #matogrossodosul #dadosabertos #votoconsciente #transparência #política #brasil

---

## Números desta região

- 44 candidaturas em 4 estados
- 35 com @ declarado ao TSE, 9 sem
- dos 9 sem @: 4 não declararam nenhuma rede ao TSE, 3 declararam outras redes e 2 declararam só o site do partido
- 13 ainda não têm nenhuma informação no acervo

**Os 35 @ do Centro-Oeste foram conferidos um a um:** todos saem de uma URL
...
- Gerado por `python gerar_artes_regiao.py --regiao Centro-Oeste`.
